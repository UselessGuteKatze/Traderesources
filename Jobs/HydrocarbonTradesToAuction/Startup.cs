...
namespace HydrocarbonTradesToAuction {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddHttpClient()
                .Configure<HydrocarbonTradesToAuctionJobsConfig>(options =>
                {
                    options.AuctionIntegrationServiceUrl = Configuration["AuctionIntegrationServiceUrl"];
                })
                .AddHydrocarbonTradesToAuctionJobsConsumer()
                .AddWaitingHydrocarbonTradesFromAuctionJobsConsumer()
                .AddHeldHydrocarbonTradesFromAuctionJobsConsumer()
                .AddHealthChecks()
    ...
    public class HydrocarbonTradesToAuctionJobsConfig {
