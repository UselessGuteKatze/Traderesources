...
namespace ForestTradesToAuction {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddHttpClient()
                .Configure<ForestTradesToAuctionJobsConfig>(options =>
                {
                    options.AuctionIntegrationServiceUrl = Configuration["AuctionIntegrationServiceUrl"];
                })
                .AddForestTradesToAuctionJobsConsumer()
                .AddWaitingForestTradesFromAuctionJobsConsumer()
                .AddHeldForestTradesFromAuctionJobsConsumer()
                .AddHealthChecks()
    ...
    public class ForestTradesToAuctionJobsConfig {
