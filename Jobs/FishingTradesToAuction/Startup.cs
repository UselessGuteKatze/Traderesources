    ...
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddFishingTradesToAuctionJobsConsumer()
                .AddWaitingFishingTradesFromAuctionJobsConsumer()
                .AddHeldFishingTradesFromAuctionJobsConsumer()
                .AddFishingAgreementsToAuctionJobsConsumer()
                .AddHealthChecks()
