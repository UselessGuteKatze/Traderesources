...
namespace HuntingTradesToAuction {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                .AddHttpClient()
                .Configure<HuntingTradesToAuctionJobsConfig>(options =>
                {
                    options.AuctionIntegrationServiceUrl = Configuration["AuctionIntegrationServiceUrl"];
                })
                .AddHuntingTradesToAuctionJobsConsumer()
                .AddWaitingHuntingTradesFromAuctionJobsConsumer()
                .AddHeldHuntingTradesFromAuctionJobsConsumer()
                .AddHuntingAgreementsToAuctionJobsConsumer()
                .AddHealthChecks()
    ...
    public class HuntingTradesToAuctionJobsConfig {
