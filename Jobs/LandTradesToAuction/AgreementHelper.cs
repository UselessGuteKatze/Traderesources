...
namespace LandTradesToAuction
{
    ...
    public class RefAgreementType : ReferenceEnum<AgreementTypes>
    {
        ...
        public RefAgreementType() : base(RefName, "Статусы договора", new Dictionary<AgreementTypes, string> {
            {AgreementTypes.LandPrivate, "Договор купли-продажи земельного участка"},
            {AgreementTypes.LandRentRights, "Договор купли-продажи права аренды земельного участка"}
        })
        {
        }
    }
    ...
    {
        public ConfiscateAgreementsModel(int flAuctionId, int flAgreementId, AgreementTypes flAgreementType, ConfiscateAgreementStatuses flAgreementStatus, DateTime flCreateDate, DateTime? flActivateDate)
        {
            this.flAuctionId = flAuctionId;
            this.flAgreementId = flAgreementId;
            this.flAgreementType = flAgreementType;
        ...
        public int flAgreementId { get; set; }
        public AgreementTypes flAgreementType { get; set; }
    ...
    public static class AgreementHelper
    {
        ...
        public static bool ExistsTbConfiscateAgreements(int auctionId, int agreementId, AgreementTypes agreementType, IQueryExecuter queryExecuter)
        {
            return new TbConfiscateAgreements()
                .AddFilter(t => t.flAuctionId, auctionId)
                .AddFilter(t => t.flAgreementId, agreementId)
                .AddFilter(t => t.flAgreementType, agreementType)
        ...
        public static void InsertTbConfiscateAgreements(ConfiscateAgreementsModel agreement, IQueryExecuter queryExecuter, ITransaction transaction = null)
        {
            new TbConfiscateAgreements()
                ...
                .SetT(t => t.flAgreementType, agreement.flAgreementType)
        ...
        public static void UpdateTbConfiscateAgreementsStatus(int auctionId, int agreementId, AgreementTypes agreementType, ConfiscateAgreementStatuses status, DateTime? activateDate, IQueryExecuter queryExecuter, ITransaction transaction = null)
        {
            new TbConfiscateAgreements()
                .AddFilter(t => t.flAuctionId, auctionId)
                .AddFilter(t => t.flAgreementId, agreementId)
