...
namespace TradeResourcesPlugin.Modules.HydrocarbonMenus.Trades {
    public class MnuHydrocarbonTradeOrdersSearch : FrmMenu {
        public MnuHydrocarbonTradeOrdersSearch(string moduleName) : base(nameof(MnuHydrocarbonTradeOrdersSearch), "Приказы по конкурсам")
        {
                        ...
                        t => new[] {
                            t.Column("Действия", (env, r) =>
                                new Link
                                {
                                    ...
                                    RouteValues = new HydrocarbonTradeOrderQueryArgs { MenuAction = "view-order", RevisionId = r.GetVal(t => t.L.L.flRevisionId) },
