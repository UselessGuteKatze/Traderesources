...
namespace TradeResourcesPlugin.Modules.TelecomOperatorsMenus.Trades {
    public class MnuTelecomOperatorsTradeOrdersSearch : FrmMenu {
        public MnuTelecomOperatorsTradeOrdersSearch(string moduleName) : base(nameof(MnuTelecomOperatorsTradeOrdersSearch), "Приказы по конкурсам")
        {
                        ...
                        t => new[] {
                            t.Column("Действия", (env, r) =>
                                new Link
                                {
                                    ...
                                    RouteValues = new TelecomOperatorsTradeOrderQueryArgs { MenuAction = "view-order", RevisionId = r.GetVal(t => t.L.L.flRevisionId) },
