...
namespace TradeResourcesPlugin.Modules.TelecomOperatorsMenus.Objects {
    public class MnuTelecomOperatorsObjectOrdersSearch : FrmMenu {

        public MnuTelecomOperatorsObjectOrdersSearch(string moduleName) : base(nameof(MnuTelecomOperatorsObjectOrdersSearch), "Приказы по объектам")
        {
