...
using FishingSource.FieldEditors.Trade;
using CommonSource;
...
namespace TradeResourcesPlugin.Modules.FishingMenus.Trades {
    public class MnuFishingTradeOrderBase : MnuOrderBaseV2<FishingTradeModel, TradeOrderTypes, FishingTradeOrderQueryArgs> {

        public MnuFishingTradeOrderBase(string moduleName, string menuName, OrderStandartPermissions perms)
        ...
        public override Task<ActionItem[]> GetActions(ActionEnv<FishingTradeOrderQueryArgs> env)
        {
            ...
            switch (env.Args.MenuAction)
            {
                case Actions.ViewOrder:
                    ...
                    if (trade != null)
                    {
                        ret.Add(new ActionItem(env.T("Перейти к объекту"), new ActionRedirectData(ModuleName, MnuFishingObjectView.MnuName, new FishingObjectViewArgs { MenuAction = "view", Id = trade.flObjectId })));
                    }
                    break;
        ...
        public override IWizardFormBuilderWithStep<FishingTradeOrderQueryArgs, ModelOrderArgs<TradeOrderTypes, FishingTradeOrderQueryArgs>, FishingTradeModel>
        EditModel(IWizardFormBuilderWithFinishButton<FishingTradeOrderQueryArgs, ModelOrderArgs<TradeOrderTypes, FishingTradeOrderQueryArgs>, FishingTradeModel> wizard) {
            return wizard
        ...
        public override FishingTradeModel GetModel(ActionEnv<FishingTradeOrderQueryArgs> env, GetModelFrom from, TradeOrderTypes orderType, ITransaction transaction)
        {
            ...
            {
                GetModelFrom.Empty => new FishingTradeModel()
                {
        ...
        public override TradeOrderTypes GetOrderType(ActionEnv<FishingTradeOrderQueryArgs> env, GetOrderModelFrom orderModelFrom)
        {
        ...
        public override string GetWizardCancelRedirectUrl(ActionEnv<FishingTradeOrderQueryArgs> env, TradeOrderTypes orderType, GetModelFrom modelFrom)
        {
            var urlHelper = env.RequestContext.GetUrlHelper();
            //TODO
            return modelFrom switch
            {
                GetModelFrom.Empty => urlHelper.YodaAction(ModuleName, nameof(MnuFishingTradeOrderBase)),
                GetModelFrom.Entity => urlHelper.YodaAction(ModuleName, nameof(MnuFishingTradeOrderBase), new FishingTradeOrderQueryArgs { Id = env.Args.Id.Value, MenuAction = "view" }),
                GetModelFrom.Revision => urlHelper.YodaAction(ModuleName, MenuName, new FishingTradeOrderQueryArgs { RevisionId = env.Args.RevisionId, MenuAction = Actions.ViewOrder }),
                _ => throw new NotImplementedException()
            };
        }

        public override ValidationResultBase IsCreateFromActionValid(ActionEnv<FishingTradeOrderQueryArgs> env)
        {
            if (env.Args.Id == null)
            {
            ...
            if (!CanCreateOrder(env.Args.Id.Value, GetOrderType(env, GetOrderModelFrom.Entity), out var error, env))
            {
                if (env.Args.Id.HasValue) {
                    return new RedirectResult(ModuleName, MnuFishingTradeView.MnuName, new MnuFishingTradeViewArgs() { tradeId = env.Args.Id.Value }, error);
                }
                else {
        ...
        public static bool CanCreateOrder(int id, TradeOrderTypes orderType, out string error, ActionEnv<FishingTradeOrderQueryArgs> env)
        {
        ...
        public override void SaveModel(int revisionId, FishingTradeModel model, TradeOrderTypes orderType, ActionEnv<FishingTradeOrderQueryArgs> env, ITransaction transaction, GetModelFrom modelFrom)
        {
        ...
        private void setObjectStatus(TradeOrderTypes orderType, FishingTradeModel model, ActionEnv<FishingTradeOrderQueryArgs> env, ITransaction transaction)
        {
            switch (orderType)
            {
                case TradeOrderTypes.Edit:
            ...
            var objectBloc = FishingObjectBlocks.ActiveFree.ToString();
            if (orderType == TradeOrderTypes.Create)
            {
                objectBloc = FishingObjectBlocks.ActiveToBeTraded.ToString();
            }
            if (orderType == TradeOrderTypes.Cancel)
            {
                objectBloc = FishingObjectBlocks.ActiveFree.ToString();
            }
        ...
        private void setModel<TTradesTable>(DataModifingQueryProxy<TTradesTable> updateOrInsert, FishingTradeModel model) where TTradesTable : TbTradesBase
        {
            updateOrInsert
        ...
        public override bool TryAcceptModel(int revisionId, FishingTradeModel model, TradeOrderTypes orderType, ActionEnv<FishingTradeOrderQueryArgs> env, ITransaction transaction, out string error)
        {
            var result = true;
        ...
        public override bool TryValidateModel(int revisionId, FishingTradeModel model, TradeOrderTypes orderType, ActionEnv<FishingTradeOrderQueryArgs> env, out string[] errors)
        {
            var result = true;
            var errorsList = new List<string>() { };
        ...
        private void setTradeChange(TradeOrderTypes orderType, FishingTradeModel model, ActionEnv<FishingTradeOrderQueryArgs> env, ITransaction transaction)
        {
        ...
        public override void ViewModel(RenderActionEnv<FishingTradeOrderQueryArgs> env, FishingTradeModel trade, TradeOrderTypes orderType, OrderStatus orderStatus)
        {
            ViewModel(env.Form, env, trade);
        }

        public static void ViewModel(WidgetBase widget, FormEnvironment env, FishingTradeModel trade)
        {
        ...
        public static void viewModelMainData(WidgetBase widget, FormEnvironment env, FishingTradeModel trade, bool collapsed = false)
        {
        ...
        public static void viewModelContestData(WidgetBase widget, FormEnvironment env, FishingTradeModel trade, bool collapsed = false)
        {
            var tbRevs = new TbTradesRevisions();
        ...
        public static void viewModelPublicationsData(WidgetBase widget, FormEnvironment env, FishingTradeModel trade, bool collapsed = false)
        {
            var tbRevs = new TbTradesRevisions();
        ...
        public static void viewModelRequisitesData(WidgetBase widget, FormEnvironment env, FishingTradeModel trade, bool collapsed = false)
        {
            var tbRevs = new TbTradesRevisions();
        ...
        public static void viewModelAgreementData(WidgetBase widget, FormEnvironment env, FishingTradeModel trade, bool collapsed = false)
        {
            var tbRevs = new TbTradesRevisions();
        ...
        public static void viewModelSaleData(WidgetBase widget, FormEnvironment env, FishingTradeModel trade, bool collapsed = false)
        {
            var tbRevs = new TbTradesRevisions();
        ...
        public static void viewModelProtocolData(WidgetBase widget, FormEnvironment env, FishingTradeModel trade, bool collapsed = false)
        {
            var tbRevs = new TbTradesRevisions();
        ...
        protected override bool HasAccessToOrder(int revisionId, ActionEnv<FishingTradeOrderQueryArgs> env)
        {
    ...
    public class FishingTradeOrderQueryArgs : OrderQueryArgs {
