...
namespace TradeResourcesPlugin.Modules.FishingMenus {
    public class MnuFishingStatistics : FrmMenu {

        private static MemoryCache _memCache = new MemoryCache(new MemoryCacheOptions());

        public MnuFishingStatistics(string moduleName) : base(nameof(MnuFishingStatistics), "Статистика")
        {
