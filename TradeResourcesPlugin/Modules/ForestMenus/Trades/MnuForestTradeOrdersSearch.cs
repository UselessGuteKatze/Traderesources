...
namespace TradeResourcesPlugin.Modules.ForestMenus.Trades {
    public class MnuForestTradeOrdersSearch : FrmMenu {
        public MnuForestTradeOrdersSearch(string moduleName) : base(nameof(MnuForestTradeOrdersSearch), "Приказы по конкурсам")
        {
                        ...
                        t => new[] {
                            t.Column("Действия", (env, r) =>
                                new Link
                                {
                                    ...
                                    RouteValues = new ForestTradeOrderQueryArgs { MenuAction = "view-order", RevisionId = r.GetVal(t => t.L.L.flRevisionId) },
