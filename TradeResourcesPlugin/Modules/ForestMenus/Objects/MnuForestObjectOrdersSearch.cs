...
namespace TradeResourcesPlugin.Modules.ForestMenus.Objects {
    public class MnuForestObjectOrdersSearch : FrmMenu {

        public MnuForestObjectOrdersSearch(string moduleName) : base(nameof(MnuForestObjectOrdersSearch), "Приказы по объектам")
        {
