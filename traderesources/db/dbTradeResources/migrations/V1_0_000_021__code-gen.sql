...
CREATE TABLE fishing.TbTradeChanges (
...
CREATE TABLE fishing.z_history_TbTradeChanges (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE TABLE fishing.z_history_TbTrades (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE TABLE fishing.TbTradesRevisions (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE TABLE fishing.z_history_TbTradesRevisions (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE TABLE fishing.TbTradesOrderResult (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE TABLE fishing.z_history_TbTradesOrderResult (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE TABLE fishing.TbTradesOrderNegotiations (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE TABLE fishing.z_history_TbTradesOrderNegotiations (
flEntityId bigint NOT NULL,
flRequestId bigint NOT NULL,
flIsHidden boolean NOT NULL,
flRequestType integer NOT NULL,
...
CREATE SEQUENCE fishing."seq_TbTradeChanges_flId";


CREATE SEQUENCE fishing."seq_TbTrades_flId";


CREATE SEQUENCE fishing."seq_TbTradesRevisions_flId";


CREATE SEQUENCE fishing."seq_TbTradesOrderResult_flSubjectId";


CREATE SEQUENCE fishing."seq_TbTradesOrderNegotiations_flActionId";