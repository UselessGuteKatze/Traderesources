...
class SpreadsheetBook extends React.Component {
  constructor(props) {
    ...
    this.emit('sg-book-loaded', {
      PageId: pageId,
      LangCode: bookInfo.CurLangCode
    });
  }
  /**
  ...
  toggleFullscreen() {
    ...
    let fsRequestFunc = ['requestFullscreen', 'msRequestFullscreen', 'mozRequestFullScreen', 'webkitRequestFullscreen'].map(x => element[x]).filter(x => typeof x === 'function')[0];
    let fsExitFunc = ['exitFullscreen', 'msExitFullscreen', 'mozCancelFullScreen', 'webkitExitFullscreen'].map(x => document[x]).filter(x => typeof x === 'function')[0];
  ...
  async onBookSave() {
    ...
    try {
      ...
      if (this.props.bookSaveFormat === 'gzip') {
        bookContent = btoa(pako.gzip(bookContent, {
          to: 'string'
        }));
      }
  ...
  renderSpreadsheetColGroup(g) {
    var cols = [/*#__PURE__*/React.createElement("col", {
      key: '-',
      span: "1",
      className: "col-rhead"
    })];
  ...
  getCellEditor(inputCellInfo, row) {
    ...
    if (cellInfo.IsRefCell) {
      let options = cellInfo.RefItems.map(x => /*#__PURE__*/React.createElement("option", {
        key: x.Code,
        value: x.Code
      }, x.Text));
      ret = /*#__PURE__*/React.createElement("select", {
        autoFocus: true,
        defaultValue: value,
      ...
      switch (dataType) {
        case 'textlines':
          ret = /*#__PURE__*/React.createElement("textarea", {
            autoFocus: true,
            defaultValue: value,
            className: "grid-cell-edit-input",
            onClick: clickHandler,
        ...
        case 'text':
          ret = /*#__PURE__*/React.createElement("input", {
            type: "text",
            autoFocus: true,
            defaultValue: value,
            className: "grid-cell-edit-input",
  ...
  renderCell(row, cell, ri, ci, isHeader) {
    ...
    let td = /*#__PURE__*/React.createElement("td", {
      key: cell.i,
      "data-ci": cell.i,
  ...
  renderRowHeaderCell(row, renderRemoveMarkers) {
    ...
    let content = !removable || row.Height < 10 ? null : /*#__PURE__*/React.createElement("span", {
  ...
  renderSpreadsheetGridPart(grid, isHeader) {
    ...
    if (isHeader) {
      ...
      rows.unshift( /*#__PURE__*/React.createElement("tr", {
        key: "fr",
        height: "3px"
      }, tds));
    }
  ...
  renderGridHeader(activePageId) {
    ...
    if (navMode === 'tabs') {
      ...
      for (let grid of categoryGrids) {
        ...
        let navItem = /*#__PURE__*/React.createElement("li", {
          className: "nav-item",
          key: grid.Id
        }, /*#__PURE__*/React.createElement("span", {
          className: className,
          onClick: () => this.onPageChange(grid.Id)
        }, grid.Id));
        navItems.push(navItem);
      }

      navTabs = /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
        colSpan: "10",
        className: "sg-nav-tabs"
      ...
      if (categories.has('') && categories.size === 1) {
        ...
        categories.set('[ALL]', {
          ...
          onClick: () => this.setLocalState({
            filterCategoryPages: false
          })
        });
      }
      ...
      for (let category of categories.values()) {
        ...
        let menuItem = /*#__PURE__*/React.createElement("div", {
          key: category.name || '-',
          className: className,
      ...
      if (menuItems.length) {
        dropdown = /*#__PURE__*/React.createElement("div", {
          ...
          "aria-haspopup": "true",
          "aria-expanded": "false"
        }, this.$t('Разделы')), /*#__PURE__*/React.createElement("div", {
      ...
      for (let grid of grids) {
        ...
        if (category !== curCategory) {
          ...
          menuItems.push( /*#__PURE__*/React.createElement("h6", {
            key: grid.Id + '-cat',
            className: "dropdown-header pl-3"
          }, curCategory || this.$t('Прочее')));
        }
        ...
        let menuItem = /*#__PURE__*/React.createElement("div", {
          ...
          className: "page-id"
        }, grid.Id), /*#__PURE__*/React.createElement("span", {
          className: "page-text ml-2"
        }, grid.Description));
        menuItems.push(menuItem);
      }
      ...
      dropdown = /*#__PURE__*/React.createElement("div", {
        ...
        "aria-haspopup": "true",
        "aria-expanded": "false"
      }, activePageId), /*#__PURE__*/React.createElement("div", {
        className: "dropdown-menu pages"
      }, menuItems));
    }

    let activeGrid = grids.filter(x => x.Id === activePageId)[0];
    let tdUnit = !activeGrid.DefaultUnit ? null : /*#__PURE__*/React.createElement("td", {
    ...
    let tdErrors = !errorsCount ? null : /*#__PURE__*/React.createElement("td", {
      className: tdErrorsClass,
      onClick: this.toggleShowErrors
    }, this.$t('Ошибки:'), " ", /*#__PURE__*/React.createElement("span", {
      className: "badge badge-danger"
    }, errorsCount));
    let showSaveButton = this.props.bookSaveUrl && !this.props.isReadonly && this.props.showSaveButton;
    let tdBtnSave = !showSaveButton ? null : /*#__PURE__*/React.createElement("td", {
      className: "fit-width"
    ...
    let tdBtnFullscreen = !showFullscreenButton ? null : /*#__PURE__*/React.createElement("td", {
      className: "fit-width"
    }, /*#__PURE__*/React.createElement("div", {
    ...
    let tdLangs = !langMenuItems.length || this.state.isReadonly ? null : /*#__PURE__*/React.createElement("td", {
      className: "fit-width"
    }, /*#__PURE__*/React.createElement("div", {
      className: "btn-group"
    }, /*#__PURE__*/React.createElement("button", {
      ...
      "aria-haspopup": "true",
      "aria-expanded": "false"
    }, langText), /*#__PURE__*/React.createElement("div", {
      className: "dropdown-menu dropdown-menu-right langs"
    }, langMenuItems)));
    let tdDropdown = null;

    if (dropdown) {
      tdDropdown = /*#__PURE__*/React.createElement("td", {
        className: "fit-width"
      }, dropdown);
    }
    ...
    }, activeGrid.Description), tdUnit, tdErrors, tdLangs, tdBtnFullscreen, tdBtnSave), navTabs)));
    return header;
  }
  ...
  render() {
    ...
    let savingDiv = !this.state.saving ? null : /*#__PURE__*/React.createElement("div", {
      className: "grid-saving"
    }, /*#__PURE__*/React.createElement("div", {
      className: "msg-background"
    }), /*#__PURE__*/React.createElement("div", {
      className: "msg-panel"
    ...
    }, savingDiv, this.renderBookErrorList(), this.renderGridHeader(activePageId), /*#__PURE__*/React.createElement("div", {
      className: "sg-table-wrapper"
    }, /*#__PURE__*/React.createElement("table", {
      className: "sg-table",
      key: activePageId,
      width: tableWidth
    }, this.renderSpreadsheetColGroup(grid), /*#__PURE__*/React.createElement("thead", null, this.renderSpreadsheetGridPart(grid, true)), /*#__PURE__*/React.createElement("tbody", {
  ...
  refreshStickyCells() {
    ...
    for (let r of table.rows) {
      for (let cell of r.cells) {
        ...
        cell.style.left = "".concat(ci && colLefts[ci] || 0, "px");
      }
    }
  }
...
$(document).ready(function () {
  $(".sg-editor").each(async function () {
    ...
    try {
      ...
      let api = {};
      ReactDOM.render( /*#__PURE__*/React.createElement(SpreadsheetBook, {
        bookInfo: bookInfo,
      ...
      $this.html("<div class=\"alert alert-danger\" role=\"alert\">".concat($t('Ошибка при загрузке таблиц'), "</div>"));
    }
  });
});
/* ------- Book Data Providers ------- */
