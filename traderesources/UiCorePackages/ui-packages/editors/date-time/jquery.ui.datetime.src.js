(function($, undefined){
  ...
  $.widget("ui.datetime", {
    ...
    _limits: function(){
      ...
      this.minDate = (o.minDate) ? this._parse(o.minDate, o.format) : new Date(1750, 0, 1, 0, 0, 0, 0);
    ...
    _clock: function(){
      var o = this.options,
        ...
        '</div></div><table><thead><tr><th><span>Ч</span></th><th><span>M</span></th></tr></thead><tbody>'+
  ...
  $.extend(Date, {
    ...
    dayNamesShort: ['Воск', 'Пон', 'Втор', 'Сред', 'Чет', 'Пят', 'Суб'],
